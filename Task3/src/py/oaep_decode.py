#!/usr/bin/env python3
"""RSA-OAEP 解密（教学版，默认 k0=512 k1=64 SHA-512）。

用法:  python oaep_decode.py <ciphertext_hex> [k0_bits] [k1_bits] [private_key_file]
       python oaep_decode.py "Ciphertext: <hex>" [k0_bits] [k1_bits] [private_key_file]

复用 Task1 的 RSA 私钥。打印恢复出的 r、X、Y、padded、明文。
"""
