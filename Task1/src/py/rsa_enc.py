#!/usr/bin/env python3
"""Textbook RSA 加密 Task1 明文。

用法:  python rsa_enc.py <plaintext> [public_key_file]

默认公钥文件为 Task1/RSA_Public_Key.txt。
打印 "Ciphertext: <hex>"，并写出 Raw_Message.txt 与 Encrypted_Message.txt。
"""
...
def main(argv: list[str]) -> int:
    ...
    print("明文与密文已保存到 Raw_Message.txt / Encrypted_Message.txt")
    return 0
